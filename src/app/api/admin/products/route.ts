...
export async function POST(req: NextRequest) {
  try {
    ...
    // Category is optional in the UI. Keep the existing DB relation intact by
    // automatically placing uncategorised products into a private-safe
    // fallback category. Admin can move them later.
