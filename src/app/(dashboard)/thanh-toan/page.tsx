...
const METHODS = [
  { id: "WALLET", label: "Thanh toán bằng ví", icon: Wallet, desc: "Trừ trực tiếp từ số dư ví, xử lý ngay lập tức." },
  { id: "BANK_TRANSFER", label: "Chuyển khoản ngân hàng", icon: Landmark, desc: "Admin xác nhận thủ công sau khi nhận được chuyển khoản." }
] as const;
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_360px]">
      <div className="flex flex-col gap-4">
        ...
        <GlassPanel radius="md" className="p-6">
          ...
          {insufficientWallet && (
            <p className="mt-2 text-caption text-state-danger">Số dư ví không đủ. Vui lòng nạp thêm hoặc chọn phương thức khác.</p>
          )}
        </GlassPanel>
